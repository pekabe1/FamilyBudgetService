...
namespace DataAccess.Migrations
{
    ...
    [Migration("20231112152745_addSharedAmountToSharedExpense")]
    partial class addSharedAmountToSharedExpense
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataAccess.Models.Expense", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ExpenseCategoryId = 1,
                            ExpenseDate = new DateTime(2023, 11, 12, 16, 27, 45, 132, DateTimeKind.Local).AddTicks(3191),
                            UserId = 1
                        },
                        new
                        {
                            ...
                            Description = "Fuel",
                            ExpenseCategoryId = 2,
                            ExpenseDate = new DateTime(2023, 11, 12, 16, 27, 45, 132, DateTimeKind.Local).AddTicks(3214),
                            UserId = 2
                        },
                        new
                        {
                            ...
                            Description = "Fuel",
                            ExpenseCategoryId = 2,
                            ExpenseDate = new DateTime(2023, 11, 12, 16, 27, 45, 132, DateTimeKind.Local).AddTicks(3216),
                            UserId = 1
                        });
                });
            ...
            modelBuilder.Entity("DataAccess.Models.Income", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 5000.0m,
                            Date = new DateTime(2023, 11, 12, 16, 27, 45, 132, DateTimeKind.Local).AddTicks(3234),
                            Description = "Salary",
                            IncomeCategoryId = 1,
                            UserId = 1
                        });
